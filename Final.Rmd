...
```{r}
clim1.rep <- network(as.matrix(read.csv2("Code/input/climate9500-rep.csv", row.names = 1, header = TRUE)))
# influence reputation network
clim1.collab <- network(as.matrix(read.csv2("Code/input/climate9500-collab.csv", row.names = 1, header = TRUE)))  
...
clim1.dm <- read.csv2("Code/input/climate9500-dm.csv", row.names = 1, header = TRUE)
...
com1 <- read.csv2("Code/input/climate9500-committee.csv", row.names = 1, header = TRUE)
