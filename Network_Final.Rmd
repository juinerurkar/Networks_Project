...
```{r}
par(mfrow=c(1,2))
cyclical <- igraph::graph(edges =c("A","B", "B", "C", "C", "A"))
plot(cyclical, mode="directed", main = "Cyclic")
acyclical <- igraph::graph(edges =c("A","B", "B", "C"))
plot(acyclical, mode="directed", layout=layout_in_circle, main = "Acyclic", directed = T)
```
