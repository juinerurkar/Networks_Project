...
names.1 <- network::get.vertex.attribute(network(climate1_reputation), "vertex.names")
...
appendix.1 <- data.frame(org = names.1, type3 = type.1[, 1], type5 = type.1[, 2], 
                         committees = committee.1, dm = dm.1$dm, betweenness = between_climate1_collab)
