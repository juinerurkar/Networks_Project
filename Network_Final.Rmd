...
fits.1 <-lapply(1:2, function(G){
    ergmm(climate1_reputation ~ euclidean(d=2, G=G) + edges + mutual + nodeocov("odeg-rep") + edgecov(climate1_collab) + nodeicov("bc-perc") + nodeifactor("dm") + nodeicov("committees"), seed = 12345)
  })
...
```{r, message = FALSE}
clim.lsm.1 <- latentnet::ergmm(climate1_reputation ~ euclidean(d=2, G = 2) + edges + mutual + nodeocov("odeg-rep") + edgecov(climate1_collab) + nodeicov("bc-perc") + nodeifactor("dm") + nodeicov("committees"), 
                               seed = 12345)
summary(clim.lsm.1)
...
fits.2 <-lapply(1:2, function(G){
    ergmm(climate2_reputation ~ euclidean(d=2, G=G) + edges + mutual + nodeocov("odeg-rep") + edgecov(climate1_collab) + nodeicov("bc-perc") + nodeifactor("dm") + nodeicov("committees"), seed = 12345)
  })
...
```{r, message = FALSE}
clim.lsm.2 <- ergmm(climate2_reputation ~ euclidean(d=2, G=2) + edges + mutual + nodeocov("odeg-rep") + edgecov(climate1_collab) + nodeicov("bc-perc") + nodeifactor("dm") + nodeicov("committees"), seed = 12345)
summary(clim.lsm.2)
plot(clim.lsm.2)
```
