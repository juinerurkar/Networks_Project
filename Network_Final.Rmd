...
```{r}
# data preparation
rep.2 <- read.csv2("data/input/climate0205-rep.csv", row.names = 1, 
    header = TRUE)
rep.2 <- network(as.matrix(rep.2))  # influence reputation network
collab.2 <- read.csv2("data/input/climate0205-collab.csv", row.names = 1, 
    header = TRUE)
...
network::set.vertex.attribute(rep.2, "odeg-rep", degree(rep.2, 
    cmode = "outdegree"))  # outdegree centrality as a vertex attribute
com.2 <- read.csv2("data/input/climate0205-committee.csv", row.names = 1, 
    header = TRUE)
...
type.2 <- read.csv2("data/input/climate0205-type.csv", row.names = 1, 
    header = TRUE)
