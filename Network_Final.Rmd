...
We replicate the ergms for both waves of the climate change policy data and the telecommunications policy in Switzerland. The original paper found these hypotheses to be true and our replication of these ergms were consistent with their findings. Furthermore, our results when running LSM's on these same netwrok datasets revealed similar results. 
